...
public class CryptoUtil {
    ...
    public static String desEncryptEncodeBase64(String data, String key, String ivs) {
     ...
     */
    @SuppressWarnings("restriction")
    public static String desDecryptDecodeBase64(String data, String key, String ivs) {
